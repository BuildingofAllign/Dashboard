...
const navItems = [
  ...
  { icon: <ProjectsIcon />, label: "Projekter", active: false },
  { 
    icon: (
...
export const Sidebar: React.FC = () => {
  return (
    <div className="w-64 flex flex-col justify-between bg-indigo-700 p-6 max-sm:hidden">
      <div>
        ...
        <nav className="flex flex-col gap-2">
          {navItems.map((item, index) => (
            <button
              key={index}
              className={`flex items-center text-white text-[15px] cursor-pointer p-3 rounded-lg hover:bg-indigo-800 transition-colors ${
      ...
      <button className="flex items-center text-white text-[15px] cursor-pointer p-3 rounded-lg hover:bg-indigo-800 transition-colors">
